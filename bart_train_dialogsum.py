...
metric = load_metric("dialogsum-main/Baseline/rouge_tool.py")
...
raw_datasets = transform_dialogsumm_to_huggingface_dataset("data/dialogsum/dialogsum.train.jsonl",
                                                           "data/dialogsum/dialogsum.dev.jsonl",
...
with open("summaries/dialogsum_bart_large.txt", "w") as f:
