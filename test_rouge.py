...
def test_rouge(cand, ref):
    ...
    try:
        ...
        r = pyrouge.Rouge155("/home/guoqing/anaconda3/envs/pgn/lib/python3.7/site-packages/pyrouge/ROUGE-1.5.5/")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--c', type=str, default="summaries/bart_large.txt",
                        help='candidate file')
    parser.add_argument('--r', type=str, default="summaries/golden.txt",
                        help='reference file')
